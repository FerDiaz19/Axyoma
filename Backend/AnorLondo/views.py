...
class EvaluacionCompletada(generic.View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try: # Intenta obtener el objeto ResultadoEvaluacion....
            infoCertificado = ResultadoEvaluacion.objects.get(resultado_id=resultado)
        ...
        self.context = {
            "empleadoNombre": infoCertificado.asignacion_empleado.empleado.nombre_completo,
            "empleadoPlanta": infoCertificado.asignacion_empleado.empleado.planta.nombre,
            "empleadoEmpresa": infoCertificado.asignacion_empleado.empleado.empresa.nombre,

            "fechaCompletado": infoCertificado.asignacion_empleado.fecha_completado,
            "evaluacionNombre": infoCertificado.asignacion_empleado.asignacion.evaluacion.titulo,
            "evaluacionTipo": infoCertificado.asignacion_empleado.asignacion.evaluacion.tipo_evaluacion.nombre,
            "evaluacionEvaluable": infoCertificado.asignacion_empleado.asignacion.evaluacion.umbral_aprobacion,

            "puntajeTotal": infoCertificado.puntaje_total,
            "preguntasCorrectas": infoCertificado.num_respuestas_correctas,
            "preguntasEvaluables": infoCertificado.num_preguntas_evaluables,
            "aprobacionObtenida": infoCertificado.aprobado,
        }
