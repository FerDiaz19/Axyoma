    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_registro', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.BooleanField(default=True)),
                ('administrador', models.OneToOneField(db_column='administrador', on_delete=django.db.models.deletion.CASCADE, to='users.perfilusuario')),
            ],
            options={
                'db_table': 'empresas',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_registro', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.BooleanField(default=True)),
                ('planta', models.ForeignKey(db_column='planta', on_delete=django.db.models.deletion.CASCADE, to='users.planta')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_registro', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.BooleanField(default=True)),
                ('puesto', models.ForeignKey(db_column='puesto_id', on_delete=django.db.models.deletion.CASCADE, to='users.puesto')),
            ],
            options={
                'db_table': 'empleados',
            },
