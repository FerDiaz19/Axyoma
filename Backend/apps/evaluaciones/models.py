...
''' Modelos para las entidades relacionadas a las evaluaciones (Ed Rubio) '''
...
class Evaluacion(models.Model):
    ...
    empresa = models.ForeignKey(
        'users.Empresa', null=True, blank=True,
    ...
    creado_por = models.ForeignKey(
        'users.PerfilUsuario', on_delete=models.SET_NULL,
...
class Asignacion(models.Model):
    ...
    empleado_evaluado = models.ForeignKey(
        ...
        blank=True, null=True,
        db_column='empleado_evaluado_id',
