...
urlpatterns = [
    ...
    path('superadmin/listar_suscripciones/', SuperAdminViewSet.as_view({'get': 'listar_suscripciones'})),
    ...
    path('suscripciones/listar_suscripciones/', SuscripcionViewSet.as_view({'get': 'listar_suscripciones'})),
