-- =============================================================================
-- ARCHIVO SQL AXYOMA PARA POSTGRESQL - VERSIÓN LIMPIA
-- =============================================================================
-- Este script está dividido en tres secciones:
...
-- -----------------------------------------------------
-- 1.2 SISTEMA DE EMPRESAS Y ORGANIZACIONES
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS empleados (
    ...
    CONSTRAINT fk_empleados_departamento FOREIGN KEY (departamento) REFERENCES departamentos(departamento_id),
    CONSTRAINT fk_empleados_planta FOREIGN KEY (planta) REFERENCES plantas(planta_id)
);
...
-- -----------------------------------------------------
-- 1.3 SISTEMA DE SUSCRIPCIONES Y PAGOS
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 1.4 SISTEMA DE EVALUACIONES - ESTRUCTURA BASE
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 1.5 SISTEMA DE EVALUACIONES - PREGUNTAS Y OPCIONES
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 2.2 DATOS DE EMPRESAS Y ESTRUCTURA ORGANIZACIONAL
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- 2.3 DATOS DE SUSCRIPCIONES Y PAGOS
-- -----------------------------------------------------
...
-- Datos de ejemplo para suscripciones (3 suscripciones)
...
-- -----------------------------------------------------
-- 2.4 DATOS DE EVALUACIONES Y PREGUNTAS
-- -----------------------------------------------------
...
-- Datos de ejemplo para evaluaciones (3 evaluaciones)
